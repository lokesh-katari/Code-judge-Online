        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="-m-8 flex flex-wrap items-center justify-between">
            <div className="w-auto p-8">
              <a href="#">
                <div className="inline-flex items-center text-3xl font-bold leading-none  space-x-4">
                  <span className="text-slate-900 " t>
                    {" "}
                    CodeRealm
                  </span>
                </div>
            ...
            <div className="w-auto p-8">
              <ul className="-m-5 flex flex-wrap items-center">
                ...
                <li className="p-5">
                  <a
                    className="font-medium text-gray-600 hover:text-gray-700"
                    href="mailto:lokeshkatari921@gmail.com"
                  >
                    Contact Us
                  </a>
                </li>
            ...
            <div className="w-auto p-8">
              <div className="-m-1.5 flex flex-wrap">
                ...
                <div className="w-auto p-1.5">
                  <a
                    href="https://www.instagram.com/lokesh.katari/"
                    target="__blank"
                  >
                    <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                      <svg
                ...
                <div className="w-auto p-1.5">
                  <a
                    href="https://www.linkedin.com/in/lokesh-katari-517620225/"
                    target="__blank"
                  >
                    <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                      <svg
                ...
                <div className="w-auto p-1.5">
                  <a href="https://github.com/lokesh-katari" target="__blank">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
